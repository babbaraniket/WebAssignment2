 ...
 * Purpose: Manage the connection string and interaction with the restful API.
 */
package service;


import cst8218.babb0017.entity.Sprite;
...
@Path("cst8218.babb0017.entity.sprite")
public class SpriteFacadeREST extends AbstractFacade<Sprite> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void updates(@PathParam("id") Long id, Sprite entity) {
        super.updates(entity);
    }
